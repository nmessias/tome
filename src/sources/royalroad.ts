 ...
 * All scraping logic stays in src/services/scraper.ts / royalroad-*.
 */
import type { Source, CredentialField } from "../services/source-registry";
...
import { performAutoLogin, ROYAL_ROAD_AUTO_LOGIN_ENABLED } from "../services/royalroad-auth";
